...
class Board
  ...
  def coordinates_equal_length(ship, coordinate)
  ...
  def placed_consecutively(coordinates)
    return true if placed_consecutive_numbers?(coordinates) == true || placed_consecutive_letters?(coordinates) == true
    false
  end
  ...
  def valid_placement?(ship, coordinates)
    return true if placed_consecutively(coordinates) == true && ship_fits(ship, coordinates) == true && cell.empty? == true
    false
  end
